...
#from >> https://www.kaggle.com/code/davidbnn92/task-tagging

skill_series = {}

# 0-5
skill_series['007bbfb7.json'] = ['image_repetition', 'fractal_repetition']
skill_series['00d62c1b.json'] = ['flood_fill']
...
for skill in skill_series.values():
    skill_list = skill_list | set(skill)
